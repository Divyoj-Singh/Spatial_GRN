...
opt=contset(opt,'MaxNumPoints',40000);
...
gammaA=1;  gammaB=0.5;  %Degradation rate
gA=10;          gB=10;  %Production rate


% B0=5;  lB0A=0.2;   nB0A=10; 

A0B=10; B0A=10; A0A=10 ; B0B=10; %Threshold
lB0A=0.1; lA0B=0.1 ; lA0A=3; lB0B=3;%Fold change
nB0A=2; nA0B=2; nA0A=3; nB0B=3; %Hill's coefficient
